...
def test_context_accepts_spec_defined_fields() -> None:
    ...
    report = Report(
        pressure_standards={"AW0": {"FSB": {"C1": 12.0}}},
        BCP_calibrated_by_controller={"AW0": {"FSB": {"C1": 12.0}}},
        warnings=[],
        clamp_events=[],
        trace=[],
    )
    ...
    context = Context(
        ...
        Mass_by_controller={"AW0": {"C1": {"mass_static": 1.0, "mass_dynamic": 1.1}}},
        F_by_controller={"FSB": {"AW0": {"C1": 10.0}}},
        BCP_base_by_controller={"FSB": {"AW0": {"C1": 12.0}}},
        k_used_by_controller={"FSB": {"AW0": {"C1": 1.0}}},
        BCP_calibrated_by_controller={"AW0": {"FSB": {"C1": 12.0}}},
        clamp_events=[],
        warnings=[],
        trace=[],
    ...
    assert context.report.BCP_calibrated_by_controller == {"AW0": {"FSB": {"C1": 12.0}}}
